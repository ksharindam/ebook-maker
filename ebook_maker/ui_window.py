...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/ebook-maker.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/go-up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/go-down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/rotateleft.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rotateLeftBtn.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/rotateright.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rotateRightBtn.setIcon(icon4)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 263, 273))
        ...
        self.gridLayout_2.addWidget(self.filenameEdit, 1, 0, 1, 1)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/pdf.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.createPdfBtn.setIcon(icon6)
        ...
        self.compressBtn = QtWidgets.QCheckBox(Dialog)
        self.compressBtn.setChecked(True)
        self.compressBtn.setObjectName("compressBtn")
        self.gridLayout.addWidget(self.compressBtn, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", ".pdf"))
        ...
        self.clearBgBtn.setToolTip(_translate("Dialog", "Convert to Monochrome image"))
        self.clearBgBtn.setText(_translate("Dialog", "Clear Background"))
        self.compressBtn.setToolTip(_translate("Dialog", "Compress color image"))
